...
#line 12 "./src/fb1_5.y"
                       { printf("= %d\n", yyvsp[-1]); }
#line 1067 "fb1_5.tab.c"
    break;

  case 4: /* exp: factor  */
#line 15 "./src/fb1_5.y"
            {yyval = yyvsp[0]; }
#line 1073 "fb1_5.tab.c"
    break;

  case 5: /* exp: exp ADD factor  */
#line 16 "./src/fb1_5.y"
                     { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1079 "fb1_5.tab.c"
    break;

  case 6: /* exp: exp SUB factor  */
#line 17 "./src/fb1_5.y"
                     { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1085 "fb1_5.tab.c"
    break;

  case 7: /* factor: term  */
#line 20 "./src/fb1_5.y"
             {yyval = yyvsp[0]; }
#line 1091 "fb1_5.tab.c"
    break;

  case 8: /* factor: factor MUL term  */
#line 21 "./src/fb1_5.y"
                      { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1097 "fb1_5.tab.c"
    break;

  case 9: /* factor: factor DIV term  */
#line 22 "./src/fb1_5.y"
                      { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1103 "fb1_5.tab.c"
    break;

  case 10: /* term: NUMBER  */
#line 25 "./src/fb1_5.y"
             {yyval = yyvsp[0]; }
#line 1109 "fb1_5.tab.c"
    break;

  case 11: /* term: ABS term  */
#line 26 "./src/fb1_5.y"
               { yyval = yyvsp[0]>=0 ? yyvsp[0] : -yyvsp[0]; }
#line 1115 "fb1_5.tab.c"
    break;


#line 1119 "fb1_5.tab.c"
